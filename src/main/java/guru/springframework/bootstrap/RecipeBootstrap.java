...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        Optional<UnitOfMeasure> eachUomOptional = unitOfMeasureRepository.findUnitOfMeasureByUom("Peach");
        ...
        Optional<UnitOfMeasure> pintUomOptional = unitOfMeasureRepository.findUnitOfMeasureByUom("Pint");

        if(!pintUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not Found");
        }

        Optional<UnitOfMeasure> cupsUomOptional = unitOfMeasureRepository.findUnitOfMeasureByUom("Cup");
